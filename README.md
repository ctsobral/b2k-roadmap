...
<title>B2K Roadmap BUCS-345 v2026-04-08</title>
...
nav{position:fixed;top:0;left:0;right:0;z-index:300;background:rgba(10,14,26,.97);backdrop-filter:blur(20px);border-bottom:1px solid var(--border);height:44px;display:flex;align-items:center;padding:0 16px;gap:6px;}
...
.qbar{position:fixed;top:44px;left:0;right:0;z-index:290;background:rgba(10,14,26,.97);backdrop-filter:blur(16px);border-bottom:1px solid var(--border);padding:0 16px;display:flex;align-items:center;gap:5px;height:44px;overflow-x:auto;}
...
.sbar{max-width:100%;margin:0;padding:92px 16px 8px;display:flex;gap:8px;flex-wrap:nowrap;}
...
.main{max-width:100%;margin:0;padding:0 16px 40px;}
.qtrow{display:flex;align-items:center;gap:8px;margin-bottom:6px;flex-wrap:wrap;}
...
.leg{display:flex;gap:10px;flex-wrap:wrap;margin-bottom:6px;align-items:center;}
...
.gantt{display:grid;grid-template-columns:240px 1fr;border:1px solid var(--border);border-radius:10px;overflow:hidden;background:var(--bg2);}
...
.er{display:flex;align-items:flex-start;padding:5px 8px;height:52px;min-height:52px;border-bottom:1px solid var(--border);gap:6px;overflow:hidden;}
...
.er-name{font-size:11px;color:var(--text);line-height:1.3;overflow:hidden;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;}
...
.gr{position:relative;height:52px;min-height:52px;border-bottom:1px solid var(--border);display:flex;align-items:center;}
...
<nav>
  ...
  <div class="nright">Progresso: <b style="color:#21C25E">25%</b> &middot; 23/91</div>
</nav>

<div class="qbar">
  <button class="qb sel" data-q="all"     onclick="selQ(this)">&#x1F5FA; Todos <span class="qcnt" style="background:rgba(255,255,255,.08);color:var(--text)">91</span></button>
  ...
  <button class="qb"     data-q="Backlog"  onclick="selQ(this)">&#x1F4CB; Backlog <span class="qcnt" style="background:rgba(100,116,139,.15);color:#94A3B8">25</span></button>
...
<div class="sbar">
  <div class="sc" onclick="selQByName('all')"><div class="lbl">Total</div><div class="num" style="color:var(--text)">91</div><div class="sub">&#233;picos</div></div>
  <div class="sc" onclick="selQByName('all')"><div class="lbl">&#x2705; Conclu&#237;dos</div><div class="num" style="color:#21C25E">23</div><div class="sub">25% do total</div></div>
  ...
  <div class="sc" onclick="selQByName('Backlog')"><div class="lbl">&#x1F4CB; Backlog</div><div class="num" style="color:#94A3B8">25</div><div class="sub">sem data limite</div></div>
</div>
...
var G2 = [
  ...
  {key:"CAC-2091",name:"[MVP5] - Informacional - Regulat\u00f3rio - P4",status:"wishlist",mvp:"Backlog",start:"2026-04-08",due:"",assignee:"",quarter:"Backlog"},
  {key:"CAC-2090",name:"[MVP5] - Informacional - Pagamento - P4",status:"wishlist",mvp:"Backlog",start:"2026-04-08",due:"",assignee:"",quarter:"Backlog"},
  {key:"CAC-2089",name:"[MVP5] - Informacional - Faturas - P4",status:"wishlist",mvp:"Backlog",start:"2026-04-08",due:"",assignee:"",quarter:"Backlog"},
  {key:"CAC-2088",name:"[MVP5] - Informacional - Limites - P4",status:"wishlist",mvp:"Backlog",start:"2026-04-08",due:"",assignee:"",quarter:"Backlog"},
  {key:"CAC-2087",name:"[MVP6] - Regulat\u00f3rio - P4",status:"wishlist",mvp:"Backlog",start:"2026-04-08",due:"",assignee:"",quarter:"Backlog"},
  {key:"CAC-2086",name:"[MVP5] - Informacional - Cobran\u00e7a - P4",status:"wishlist",mvp:"Backlog",start:"2026-04-08",due:"",assignee:"",quarter:"Backlog"},
  {key:"CAC-2085",name:"[MVP5] - Informacional - Autorizadores - P4",status:"wishlist",mvp:"Backlog",start:"2026-04-08",due:"",assignee:"",quarter:"Backlog"},
  {key:"CAC-2084",name:"[MVP5] - Informacional - Conta - P4",status:"wishlist",mvp:"Backlog",start:"2026-04-08",due:"",assignee:"",quarter:"Backlog"},
  {key:"CAC-2083",name:"[MVP5] - Informacional - B2K - P4",status:"wishlist",mvp:"Backlog",start:"2026-04-08",due:"",assignee:"",quarter:"Backlog"},
  {key:"CAC-2082",name:"[MVP5] - Informacional - Faturas - P3",status:"wishlist",mvp:"Backlog",start:"2026-04-08",due:"",assignee:"",quarter:"Backlog"},
  {key:"CAC-2081",name:"[MVP4] - Informacional - Cobran\u00e7a - P3",status:"wishlist",mvp:"Backlog",start:"2026-04-08",due:"",assignee:"",quarter:"Backlog"},
  {key:"CAC-2080",name:"[MVP4] - Informacional - B2K - P3",status:"wishlist",mvp:"Backlog",start:"2026-04-08",due:"",assignee:"",quarter:"Backlog"},
  {key:"CAC-2079",name:"[MVP4] - Informacional - Autorizadores - P3",status:"wishlist",mvp:"Backlog",start:"2026-04-08",due:"",assignee:"",quarter:"Backlog"},
  {key:"CAC-2078",name:"[MVP4] - Informacional - Conta - P3",status:"wishlist",mvp:"Backlog",start:"2026-04-08",due:"",assignee:"",quarter:"Backlog"},
  {key:"CAC-2077",name:"[MVP4] - Concilia\u00e7\u00e3o - P2",status:"wishlist",mvp:"Backlog",start:"2026-04-08",due:"",assignee:"",quarter:"Backlog"},
  {key:"CAC-2076",name:"[MVP4] - Cont\u00e1bil - P2",status:"wishlist",mvp:"Backlog",start:"2026-04-08",due:"",assignee:"",quarter:"Backlog"},
  {key:"CAC-2075",name:"[MVP4] - Regulat\u00f3rio - P2",status:"wishlist",mvp:"Backlog",start:"2026-04-08",due:"",assignee:"",quarter:"Backlog"},
  {key:"CAC-2074",name:"[MVP4] - Descontinuar - P1",status:"wishlist",mvp:"Backlog",start:"2026-04-08",due:"",assignee:"",quarter:"Backlog"},
  {key:"CAC-2073",name:"[MVP4] - Concilia\u00e7\u00e3o - P1",status:"wishlist",mvp:"Backlog",start:"2026-04-08",due:"",assignee:"",quarter:"Backlog"},
  {key:"CAC-2072",name:"[MVP4] - Informacional - Cobran\u00e7a - P1",status:"wishlist",mvp:"Backlog",start:"2026-04-08",due:"",assignee:"",quarter:"Backlog"},
  {key:"CAC-2071",name:"[MVP4] - Cont\u00e1bil - P1",status:"wishlist",mvp:"Backlog",start:"2026-04-08",due:"",assignee:"",quarter:"Backlog"},
  {key:"CAC-2070",name:"[MVP4] - Regulat\u00f3rio - P1",status:"wishlist",mvp:"Backlog",start:"2026-04-08",due:"",assignee:"",quarter:"Backlog"},
  {key:"CAB2K-1086",name:"[MVP5] - Limites Cross (CDT / FGTS / ON-US)",status:"wishlist",mvp:"Backlog",start:"2026-07-01",due:"2026-09-30",assignee:"",quarter:"Backlog"},
